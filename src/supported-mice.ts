...
export const MICE: Mouse[] = [
  ...
  { brand: "Redragon", model: "M724 K1NG 1K",           status: "supported", req: 0,
    pids: [0xfc7a],
  ...
  // DAREU ───────────────────────────────────────────────────────────────
  { brand: "Dareu",    model: "A950 PRO Mg",            status: "supported", req: 0,
    pids: [0x1114, 0x1117],
  ...
  { brand: "Razer", model: "Naga V2 Pro",               status: "likely",    req: 3,
    note: "In Razer registry — needs hardware test" },
  { brand: "Razer", model: "DeathAdder V3 Pro",         status: "supported", req: 2,
    pids: [0x00b6, 0x00b7],
  ...
  { brand: "Razer", model: "Orochi V2",                 status: "likely",    req: 1,
    note: "Wireless — in Razer registry" },
  { brand: "Razer", model: "Cobra Pro",                  status: "likely",    req: 1,
    pids: [0x00af, 0x00b0],
  ...
  { brand: "Razer", model: "DeathAdder V2 Mini",        status: "likely",    req: 0,
    pids: [0x008c],
    note: "In Razer registry — needs hardware test" },
  { brand: "Razer", model: "DeathAdder V3 HyperSpeed",  status: "likely",    req: 0,
    pids: [0x00c4, 0x00c5],
  ...
  { brand: "Razer", model: "Lancehead Tournament Edition", status: "likely", req: 0,
    pids: [0x0060],
    note: "In Razer registry — needs hardware test" },
  ...
  { brand: "Razer", model: "Mamba Elite",               status: "likely",    req: 0,
    pids: [0x006c],
    note: "In Razer registry — needs hardware test" },
  { brand: "Razer", model: "Mamba Tournament Edition",  status: "likely",    req: 0,
    pids: [0x0046],
    note: "In Razer registry — needs hardware test" },
  ...
  { brand: "Razer", model: "Naga Left-Handed Edition 2020", status: "likely", req: 0,
    pids: [0x008d],
    note: "In Razer registry — needs hardware test" },
  { brand: "Razer", model: "Naga Pro",                  status: "likely",    req: 0,
    pids: [0x008f, 0x0090],
  ...
  { brand: "Razer", model: "Taipan",                    status: "likely",    req: 0,
    pids: [0x0034],
    note: "In Razer registry — needs hardware test" },
  { brand: "Razer", model: "Viper Mini Signature Edition", status: "likely", req: 0,
    pids: [0x009e, 0x009f],
  ...
  { brand: "SteelSeries", model: "Rival 3 (wired)",      status: "supported", req: 0,
    pids: [0x1824, 0x184c],
  ...
  { brand: "VAXEE", model: "AX Wireless",               status: "supported", req: 0,
    pids: [0x1005],
  ...
  { brand: "Lamzu", model: "Inca",                      status: "supported", req: 1,
  ...
  { brand: "Lamzu", model: "Atlantis (shared family ids)", status: "likely", req: 0,
    pids: [0xf50f],
  ...
  { brand: "Asus",     model: "ROG Gladius II P502",    status: "supported", req: 0,
    pids: [0x1845],
